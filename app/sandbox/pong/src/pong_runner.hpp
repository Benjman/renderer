    ...
    public:
        PongRunner(GLFWwindow *window, display_profile_t display_profile)
            ...
            m_texture(std::vector<GLfloat>(m_width * m_height * 3)) {
                ...
                m_registry.emplace<Position2D>(player_paddle, 20., m_height - 20.);
                m_registry.emplace<Player>(player_paddle);

                m_registry.emplace<Sprite>(ai_paddle, 12, 96, glm::vec3(1.));
                m_registry.emplace<Position2D>(ai_paddle, m_width - 30., 20.);
                m_registry.emplace<AI>(ai_paddle, m_width - 30, 20);

                m_registry.emplace<Sprite>(ball, 8, glm::vec3(1.));
                m_registry.emplace<Position2D>(ball, (m_width / 2.) - 16., (m_height / 2.) - 16.);
