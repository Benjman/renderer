...
struct Texture {
	...
	* GL_UNSIGNED_INT_2_10_10_10_REV
	...
	Texture(GLenum target, GLint mipmapLevel, GLint internalFormat, GLsizei width, GLenum format, GLenum type);
	Texture(GLenum target, GLint mipmapLevel, GLint internalFormat, GLsizei wight, GLsizei height, GLenum format, GLenum type);
