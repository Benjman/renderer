...
display_profile_t window::find_display_profile(size_t width, size_t height) {
    if (width == 640 && height == 480) return DISPLAY_PROFILE_640_480;
    if (width == 1280 && height == 720) return DISPLAY_PROFILE_1280_720;
    if (width == 1920 && height == 1080) return DISPLAY_PROFILE_1920_1080;
    if (width == 2560 && height == 1440) return DISPLAY_PROFILE_2560_1440;
    if (width == 2048 && height == 1080) return DISPLAY_PROFILE_2048_1080;
    if (width == 3840 && height == 2160) return DISPLAY_PROFILE_3840_2160;
    if (width == 7680 && height == 4320) return DISPLAY_PROFILE_7680_4320;
    return 0;
}
